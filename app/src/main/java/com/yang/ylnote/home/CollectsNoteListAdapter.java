 ...
 */
public class CollectsNoteListAdapter extends RecyclerView.Adapter<CollectsNoteListAdapter.ViewHolder> {
    ...
    public CollectsNoteListAdapter(List<Note> items, CollectsFragment.OnCollectsFragmentInteractionListener listener, Context context) {
        mValues = items;
        mListener = listener;
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onCollectsFragmentInteraction(holder.mItem);
                }
            }
        });
    }
